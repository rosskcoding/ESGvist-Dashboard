...
USER_SPECS = [
    DemoUserSpec(
        key="platform_admin",
        email="platform.admin@northwind-demo.local",
    ...
    DemoUserSpec(
        key="esg_manager",
        email="esg.manager@northwind-demo.local",
        full_name="Ethan ESG Manager",
        org_role="esg_manager",
    ),
    DemoUserSpec(
        key="reviewer",
        email="reviewer@northwind-demo.local",
        full_name="Rita Reviewer",
        org_role="reviewer",
    ),
    DemoUserSpec(
        key="auditor",
        email="auditor@northwind-demo.local",
        full_name="Ava Auditor",
        org_role="auditor",
    ),
    DemoUserSpec(
        key="collector_energy",
        email="collector.energy@northwind-demo.local",
        full_name="Cole Energy Collector",
        org_role="collector",
    ),
    DemoUserSpec(
        key="collector_climate",
        email="collector.climate@northwind-demo.local",
...
async def main() -> None:
    ...
    async with session_factory() as session:
        ...
        session.add(
            UserInvitation(
                organization_id=org.id,
                email="pending.facility@northwind-demo.local",
                role="collector",
    ...
    write_markdown(
        ...
        [
            ...
            "| --- | --- | --- | --- |",
            "| platform_admin | Paula Platform | `platform.admin@northwind-demo.local` | Platform-wide admin only |",
            "| admin | Alice Admin | `admin@northwind-demo.local` | Tenant admin for Northwind demo org |",
            "| esg_manager | Ethan ESG Manager | `esg.manager@northwind-demo.local` | Owns project and backup collector duties |",
            "| reviewer | Rita Reviewer | `reviewer@northwind-demo.local` | Reviews submitted data points |",
            "| auditor | Ava Auditor | `auditor@northwind-demo.local` | Audit trail / evidence verification |",
            "| collector | Cole Energy Collector | `collector.energy@northwind-demo.local` | GRI 302 energy collection |",
            "| collector | Clara Climate Collector | `collector.climate@northwind-demo.local` | GRI 305 / IFRS S2 / ESRS climate collection |",
            "",
            "Manual verification:",
            "",
