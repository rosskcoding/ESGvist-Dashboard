...
|---|--------|----------|---------|
| 1 | Стек фронтенда | React + Next.js / Vue + Nuxt | ? |
| 2 | Стек бэкенда | Node.js + Prisma / Python + Django / Go | ? |
| 3 | База данных | PostgreSQL | PostgreSQL ✅ |
| 4 | Хостинг | AWS / GCP / Self-hosted | ? |
| 5 | Файловое хранилище | S3 / MinIO / GCS | ? |
