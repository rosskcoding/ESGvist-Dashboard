...
const databaseUrl =
  process.env.DATABASE_URL || "sqlite+aiosqlite:///./playwright_form_config_resync.db";

export default defineConfig({
  testDir: "./e2e",
  testMatch: ["form-config-resync.spec.ts"],
  timeout: 120_000,
  fullyParallel: false,
  workers: 1,
  outputDir: "../artifacts/screens/form-config-resync/test-results",
  reporter: [
    ["list"],
    ["html", { outputFolder: "../artifacts/screens/form-config-resync/playwright-report", open: "never" }],
  ],
  use: {
    baseURL,
