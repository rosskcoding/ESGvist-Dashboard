...
const frontendPort = process.env.PLAYWRIGHT_FRONTEND_PORT || "3003";
...
export default defineConfig({
  ...
  fullyParallel: false,
  workers: 1,
  outputDir: "../artifacts/screens/collection-guided/test-results",
  reporter: [
    ["list"],
    ["html", { outputFolder: "../artifacts/screens/collection-guided/playwright-report", open: "never" }],
  ],
  use: {
    baseURL,
