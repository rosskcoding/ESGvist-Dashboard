...
const databaseUrl =
  process.env.DATABASE_URL || "sqlite+aiosqlite:///./playwright_custom_datasheet.db";

export default defineConfig({
  testDir: "./e2e",
  testMatch: ["custom-datasheet-screen.spec.ts"],
  timeout: 120_000,
  fullyParallel: false,
  workers: 1,
  outputDir: "../artifacts/screens/custom-datasheet/test-results",
  reporter: [
    ["list"],
    ["html", { outputFolder: "../artifacts/screens/custom-datasheet/playwright-report", open: "never" }],
  ],
  use: {
    baseURL,
